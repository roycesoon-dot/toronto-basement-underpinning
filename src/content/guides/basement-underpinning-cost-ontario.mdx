...
Basement underpinning in Ontario costs $80 to $500 per linear foot, with most Toronto projects totalling $20,000 to $50,000 for a standard detached home. Five factors drive 90% of the variance: depth gained, soil conditions, lot access, perimeter length, and whether waterproofing or finishing is bundled. This guide breaks down real 2026 pricing for each so you can evaluate quotes accurately before calling a contractor.
...
Depth gained, soil conditions, lot access, perimeter length, and bundled scope are the five variables that determine where your project lands within the $80-to-$500-per-linear-foot range.
