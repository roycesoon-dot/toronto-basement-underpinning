...
A Toronto building permit for basement underpinning takes 12 to 22 weeks from first engineer assessment to permit issuance and costs $2,000 to $4,500 in City fees, plus $1,500 to $3,000 for the engineer's assessment and $3,000 to $8,000 for sealed structural drawings. No excavation or concrete work can begin until the permit is issued. This guide covers all six phases with realistic timelines and what causes delays at each stage.
...
Phase 1 takes 2 to 4 weeks and produces the engineer's assessment report that forms the basis for all permit drawings — no application can be submitted without it, and no reputable contractor will quote without one. The engineer must assess the existing foundation conditions, the soil type, the footing dimensions, and any adjacent structures (neighbouring homes, garages, public utilities).
...
Phase 2 takes 2 to 6 weeks and produces the sealed structural drawing set required for submission — a complete package includes the pin-section sequence plan, soil bearing analysis, shoring details, new slab design, and waterproofing specifications. The permit package for a Toronto underpinning project typically includes:
...
Phase 4 takes 1 to 3 weeks once all deficiencies are resolved — permit fees at this stage run $2,000 to $4,500 for most residential underpinning projects, calculated on declared construction value, and are paid before the permit is issued. The permit is issued electronically through eSPACE and must be posted at the site during construction.
...
For further context, read our guides on [Is Basement Underpinning Safe?](/guide/is-basement-underpinning-safe/) and [What to Expect During Basement Underpinning](/guide/what-to-expect-basement-underpinning/).
